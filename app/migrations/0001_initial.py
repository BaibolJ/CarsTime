# Generated by Django 5.0.7 on 2024-08-23 16:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuel_type', models.PositiveSmallIntegerField(choices=[(1, 'Дизель'), (2, 'Бензин'), (3, 'Электро')], help_text='Тип топлива')),
                ('gearbox', models.PositiveSmallIntegerField(choices=[(1, 'Механика'), (2, 'Автомат')], help_text='Тип коробки передач')),
                ('type_car_body', models.PositiveSmallIntegerField(choices=[(1, 'Гибрид'), (2, 'Электро'), (3, 'ДВС')], help_text='Тип кузова')),
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'Забронирован'), (2, 'Свободен')], default=2, help_text='Статус доступности автомобиля')),
                ...
                ('detail_img', models.ManyToManyField(related_name='car_images', to='app.imgfile')),
            ],
        ),
        migrations.CreateModel(
            name='Rental',
